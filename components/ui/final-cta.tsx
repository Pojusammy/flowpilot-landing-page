...
export function FinalCta() {
  return (
    <section className="relative overflow-hidden bg-[#F0F4FF] px-6 pt-8 text-center md:pt-10">
      <div className="relative overflow-hidden rounded-t-[2rem] bg-[#172033] px-6 py-16 text-white isolation-isolate md:rounded-t-[3rem] md:px-10 md:py-24">
        ...
        <div className="relative mx-auto max-w-3xl">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <a
              href="#pricing"
              className="inline-flex items-center rounded-full bg-white px-8 py-3 text-xs font-light text-[#172033] transition duration-200 hover:bg-white/90"
            >
              Start Free
